...
// TODO: we also need a non-200 check for error response do this too!!!
...
struct ApiCredentials
{
    ...
    public var apiKey: String {
        get {
            return ""
//            return ApiCredentials.ApiKeys
        }
    }
    
    /// Initialise a set of `ApiKeys`
    ///
    /// - Parameter environment: This decides what key will be returned by `.apiKey`
    init(forEnvironment environment: Environment)
    {
        self.environment = environment
    }
//
//    /// Production Api Key
//    public let production =
//
//    /// Enterprise Api Key
//    public let enterprise =
//
//    /// Development Api Key
//    public let development =
//
